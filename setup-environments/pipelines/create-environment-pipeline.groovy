...
node {
	...
	stage("checkout openshift-ansible") {
		checkout([$class: 'GitSCM', 
							branches: [[name: "refs/tags/openshift-ansible-3.9.27-1"]], 
        			doGenerateSubmoduleConfigurations: false, 
        			extensions: [[$class: 'RelativeTargetDirectory', 
	...
	stage ("create image streams and templates") {
		...
		sh "oc create -f openshift-ansible/roles/openshift_examples/files/examples/v3.9/xpaas-templates -n $project"
	}
